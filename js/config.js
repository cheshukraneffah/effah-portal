// config.js - AUTO FILL PAT & BASE ID - untuk semua staff, tak perlu isi manual
(function(){
    ...
    // Set ke localStorage untuk semua key variation
    try {
    ...
    console.log('✅ Config auto-filled: PAT & Base ID set for all staff');
})();
