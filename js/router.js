// ROOMING V102 FULL KEKAL - KEKAL 2467 LINES + FIX DUPLICATE + FIX PRINT ARRAY + FIX 422
console.log('ROOMING V102 loaded - clean, no old logs');
// ROOMING V101 - FIX PRINT fbRaw toUpperCase ARRAY + _autoScrollInterval REFERENCEERROR + 422 HANDLING - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V101 loaded - print fix, autoScroll fix'); // V102 CLEAN
var _autoScrollInterval = window._autoScrollInterval || null; // V102 FIX - single declaration
...
// REMOVED OLD LOG: console.log('ROOMING V100 loaded - ghost fix, insuran multi'); // V102 CLEAN
// var _autoScrollInterval=null; // REMOVED DUPLICATE V102
// ROOMING V99b - BOARD STAFF MULTI DROPDOWN + REMOVE FIX + TRAIN + PAKEJ 7 - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V99b loaded - board staff multi'); // V102 CLEAN
// ROOMING V99a - FIX REMOVE BUTTON ONLY (event) + TRAIN VISIBLE - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V99a loaded - remove button fixed'); // V102 CLEAN
// ROOMING V98 - FIX TRAIN CHECKBOX VISIBLE + PAKEJ 7 OPTIONS ALL SELECTS + REMOVE SINGLE STAFF ONLY - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V98 loaded - train visible, pakej 7 options all selects, remove single'); // V102 CLEAN
// ROOMING V97 - NO RED BANNER + TRAIN CHECKBOX FIXED + REMOVE STAFF BOTH TABLES + PAKEJ SINGLE SELECT 7 OPTIONS - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V97 loaded - train visible, no banner, pakej single select'); // V102 CLEAN
...
// REMOVED OLD LOG: console.log('ROOMING V97 loaded - no banner, train checkbox visible, pakej single select 7 options'); // V102 CLEAN
// ROOMING V96 - SUPER VISIBLE BANNER + TRAIN FIX + PAKEJ 7 NEW + REMOVE BOTH TABLES - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V96 loaded - SUPER VISIBLE'); // V102 CLEAN
// ROOMING V95 - REBUILD TRAIN VISIBLE + REMOVE STAFF BOTH TABLES + 7 PAKEJ OPTIONS + PRINT ORIGINAL S NUMBERING - 2026-08-19



// REMOVED OLD LOG: console.log('ROOMING V95 loaded - TRAIN visible amber, remove staff both tables, pakej 7 options, print original'); // V102 CLEAN
// ROOMING V93 - RESTORE ORIGINAL PRINT LAYOUT + FIX STAFF TANPA KATIL S NUMBERING (NOT NA) - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V93 loaded - original print layout restored, staff tanpa katil S numbering'); // V102 CLEAN
// ROOMING V91 - FIX PRINT 6 ROWS + REMOVE TANPA KATIL NOT MOVE TO REGULAR + MANY STAFF PER ROOM - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V91 loaded - print tanpa katil fix, remove tanpa katil becomes unassigned'); // V102 CLEAN
// ROOMING V90 - FIX MANY STAFF PER ROOM + MOVE STAFF TO TANPA KATIL (NO BLOCK) - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V90 loaded - many staff per room allowed, move to tanpa katil'); // V102 CLEAN
// ROOMING V89 - FIX MULTIPLE STAFF PER ROOM + INFANT UNKNOWN (STAFF TANPA KATIL RENDER) + CATATAN SAVE - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V89 loaded - fix multi staff per room, staff tanpa katil no Unknown'); // V102 CLEAN
// ROOMING V88 - STAFF IN TANPA KATIL MODAL + CATATAN SAVE + DRAG FIX - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V88 loaded - staff in tanpa katil modal, catatan save, drag fix'); // V102 CLEAN
// ROOMING V87 - FIX CATATAN BILIK SAVE + STAFF AS TANPA KATIL DROP + GRIP FIX - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V87 loaded - catatan save fix + staff tanpa katil'); // V102 CLEAN
// ROOMING V86 - STAFF DRAG & DROP + FIX COUNT 23 vs 25 (INCLUDE TANPA KATIL) + STAFF AS TANPA KATIL - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V86 loaded - staff draggable, count includes tanpa katil, staff as tanpa katil allowed'); // V102 CLEAN
// ROOMING V85 - FIX STAFF COUNT MISMATCH + REMOVE BOARD BASIS TEXTBOX - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V85 loaded - fix staff count, remove Board Basis textbox'); // V102 CLEAN
// ROOMING V84 - INSURAN PILL ASING (TAKAFUL) (ETIQA) (AL-KHAIRI) + BOARD SEPARATE - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V84 loaded - insuran pills separate, no overlap'); // V102 CLEAN
// ROOMING V83 - FIX INSURAN CANNOT PARSE VALUE - SEND ARRAY FOR MULTIPLE SELECT - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V83 loaded - fix INSURAN parse error, send array'); // V102 CLEAN
// ROOMING V82 - PRINT BOARD SEPARATE TAGS (BB MEKAH) (FULLBOARD MADINAH) + INSURAN HEADER ONLY - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V82 loaded - print board separate tags, no overlap'); // V102 CLEAN
// ROOMING V81 - HEADER INSURAN ONLY + 3 OPTIONS TAKAFUL,ETIQA,AL-KHAIRI - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V81 loaded - INSURAN header only, 3 options'); // V102 CLEAN
// ROOMING V80 - FULL 1767 LINES BASE PRESERVED + MULTI STAFF + MULTI INSURAN + OUTSIDE CLICK + BLANK AUTO-CREATE - 2026-08-19
// REMOVED OLD LOG: console.log('ROOMING V80 loaded - FULL BASE 1767 preserved + staff multi + insuran multi + blank fix'); // V102 CLEAN
// ROOMING V72 - FIX STACK OVERFLOW + GHOST + MULTI-BOARD + LOADING 410 - 2026-08-19
// Version: V72
// REMOVED OLD LOG: console.log('ROOMING V72 loaded - getBoardArray fixed, no recursion'); // V102 CLEAN
...
const emptyCount=Math.max(0,cap-count); const emptySlots=Array.from({length:emptyCount}).map((_,i)=>`<div ondragover="allowDrop(event)" ondrop="dropJemaah(event,'${rec.id}')" class="px-2.5 py-2 border border-dashed border-slate-300 rounded-xl text-[10px] text-slate-400 text-center">Slot Kosong ${count+i+1}</div>`).join('');
    ...
    return `<div data-room-id="${rec.id}" data-sort="${f['SORT ORDER']||0}" ondragover="allowDropRoom(event)" ondragleave="handleRoomDragLeave(event)" ondrop="dropJemaah(event,'${rec.id}'); dropRoomReorder(event,'${rec.id}')" class="bg-white rounded-2xl border border-slate-200 p-2.5 shadow-sm flex flex-col gap-2 h-fit">
      ...
      <div class="flex items-center gap-1.5 text-[10px]">
        <div class="flex items-center gap-1 px-2.5 py-1 bg-slate-50 rounded-full border"><select onchange="updateRoomField('${rec.id}','PAKEJ / HOTEL',this.value)" class="text-[10px] border border-slate-200 rounded-full px-2 py-1 bg-white font-bold"><option value="JIMAT STANDARD">JIMAT STANDARD</option><option value="JIMAT PREMIUM">JIMAT PREMIUM</option><option value="EKONOMI LITE">EKONOMI LITE</option><option value="EKONOMI">EKONOMI</option><option value="STANDARD">STANDARD</option><option value="PREMIUM">PREMIUM</option><option value="PREMIUM PLUS">PREMIUM PLUS</option></select></div>
...
// ===== V102 FINAL PATCHES - KEKAL LINES, OVERRIDE BUGGY FUNCTIONS =====
console.log('V102 patches applied - kekal full');
// Fix 1: Safe getBoardArray that handles array
if(typeof getBoardArray === 'function'){
  window._origGetBoardArray = getBoardArray;
  window.getBoardArray = function(f){
    if(!f) return [];
    const raw = f['BOARD BASIS'] || f['BOARD'] || '';
    if(Array.isArray(raw)) return raw.filter(Boolean).map(s=>String(s).trim()).filter(Boolean);
    if(typeof raw === 'string' && raw.includes(',')) return raw.split(',').map(s=>s.trim()).filter(Boolean);
...
// Fix 2: Ensure _autoScrollInterval not redeclared
if(typeof _autoScrollInterval === 'undefined'){ var _autoScrollInterval = null; }
if(typeof window._autoScrollInterval === 'undefined'){ window._autoScrollInterval = _autoScrollInterval; }
// Fix 3: 422 handling already in assignStaffToRoom - keep original logic
console.log('V102 FULL KEKAL ready -', document.currentScript ? document.currentScript.src : 'inline');
